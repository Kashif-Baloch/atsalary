<template>
  <Navbar />
  <div class="bg-surface-900 p-12 mt-20 lg:p-20">
    <div class="flex flex-wrap lg:flex-row flex-col gap-12">
      ...
      <div class="flex-1 p-4 text-left">
        <div class="bg-gray-800 rounded-2xl p-8 lg:max-w-xl mx-auto shadow-2xl">
