<template>
  <div class="bg-surface-0 dark:bg-surface-950 min-h-screen">
    <Navbar />
    <div class="bg-surface-900 mt-20 p-12 lg:p-20">
      <div
    ...
    >
      <div class="flex flex-col gap-4">
        <div class="relative overflow-hidden">
          <div
            class="absolute left-0 top-0 h-full w-[30%] z-10 bg-linear-to-r from-surface-0 to-transparent dark:from-surface-950"
          />
          <div
            class="absolute right-0 top-0 h-full w-[30%] z-10 bg-linear-to-l from-surface-0 to-transparent dark:from-surface-950"
          />

          <div class="flex animate-marquee gap-8">
            <div class="flex gap-8 min-w-max">
              <div
                class="flex items-center justify-center px-10 gap-4 min-h-20"
              >
                <svg
                ...
                <div
                  class="text-surface-700 dark:text-surface-200 text-xl font-semibold leading-tight"
                >
                  Mistranet
                </div>
              </div>
              <div
                class="flex items-center justify-center gap-4 px-10 min-h-20"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="33"
    ...
    >
      <div class="flex flex-col gap-12 items-center">
        <div class="flex flex-col gap-4 items-center max-w-3xl mx-auto">
          ...
          >
            Discover the tools that empower your creativity and productivity.
            Tailor your experience with platforms designed to adapt to your
            needs.
          </p>
        </div>
        <div
          class="grid gap-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-4 max-w-7xl mx-auto"
        >
          <div
      ...
      <div class="mx-auto">
        <div class="xl:hidden flex flex-col gap-12">
          <div
            ...
            :key="index"
            class="grid grid-cols-1 sm:grid-cols-[42px_1fr] gap-4"
          >
    ...
    <div
      class="bg-surface-0 dark:bg-surface-900 p-20 flex flex-col items-center gap-12"
    >
      <div class="flex flex-col gap-4 text-center">
        <div class="text-blue-700 text-xl font-semibold leading-tight">
          Growth Insights
        </div>
        <div
          class="text-surface-900 dark:text-surface-0 text-4xl font-bold leading-tight"
        >
      ...
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full justify-center"
      >
        <div
          v-for="(item, index) of stats"
          :key="index"
          class="p-8 bg-blue-50/50 dark:bg-blue-400/10 rounded-2xl flex flex-col items-center gap-4"
        >
          <i :class="item.icon" class="text-4xl! text-blue-700" />
          <div class="flex flex-col gap-2">
            <div
              class="text-surface-900 dark:text-surface-0 text-3xl font-medium leading-tight text-center"
            >
              {{ item.value }}
            </div>
            <div
              class="text-blue-700 dark:text-blue-400 text-lg font-medium leading-normal text-center"
            >
              {{ item.label }}
            </div>
          </div>
    ...
    <div class="bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20">
      <div
        style="
          background: radial-gradient(
              1130.92% 141.42% at 100% 0%,
              color-mix(in srgb, var(--p-blue-700), transparent 40%) 0%,
      ...
      >
        <div class="px-12 py-20">
          <span class="uppercase text-lg text-blue-700 font-bold"
            >BE ONE OF THE FIRSTS</span
          >
          <div
            class="text-surface-0 text-4xl font-medium mt-4 mb-8 leading-tight"
          >
            Join the waitlist today!
          </div>
          <Button
            class="!bg-blue-700 !border-none !text-white !outline-none"
            type="button"
        ...
        <img
          ...
          alt="Image"
          class="static lg:absolute block mx-auto h-[28.57rem] -top-8 -right-4"
        />
      </div>
    </div>
        ...
        <div class="flex flex-1">
          <div class="flex flex-1 flex-col">
            <div class="flex flex-col">
              <div
                class="flex flex-col gap-4 p-px pr-0 h-28 md:h-[146px] relative rounded-tl-xl z-10 before:content-[''] before:absolute before:inset-0 before:pointer-events-none before:bg-linear-to-b before:from-blue-500 dark:before:from-blue-400 before:to-transparent before:border-0 before:p-px before:rounded-tl-xl before:z-0"
              >
                <div
                  class="relative z-10 h-full w-full bg-surface-0 dark:bg-surface-950 p-8 rounded-tl-xl"
                >
                  <div
                    class="text-xl md:text-3xl leading-normal text-surface-900 dark:text-surface-0"
                  >
                    Pricing
                  </div>
                  <div
                    class="text-sm leading-normal text-surface-500 dark:text-surface-400 md:flex hidden"
                  >
              ...
              <div class="flex flex-col">
                <div
                  ...
                  :key="feature"
                  class="h-[42px] flex items-center border-b border-surface-100 dark:border-surface-800"
                >
                  <div
                    class="px-8 text-sm font-medium text-surface-900 dark:text-surface-0"
                  >
                    {{ feature }}
                  </div>
                </div>
          ...
          <div class="flex flex-1 flex-col">
            <div
              class="flex flex-col gap-4 p-px pr-0 pl-0 h-28 md:h-[146px] relative z-10 before:content-[''] before:absolute before:inset-0 before:pointer-events-none before:bg-linear-to-b before:from-blue-500 dark:before:from-blue-400 before:to-transparent before:border-0 before:p-px before:z-0"
            >
              <div
                class="relative z-10 h-full w-full bg-surface-0 dark:bg-surface-950 p-4 flex flex-col items-center gap-4"
              >
                <div class="flex flex-col gap-2">
                  <div
                    class="text-lg md:text-xl leading-normal font-medium text-surface-900 dark:text-surface-0"
                  >
                    Basic
                  </div>
                  <div
                    class="text-2xl md:text-3xl leading-normal font-medium text-surface-900 dark:text-surface-0 text-center"
                  >
                    $10
                  </div>
                </div>
                <Button
                  ...
                  rounded
                  label="Free Trial"
                  class="md:flex! hidden! !bg-blue-700 !border-none !text-white !outline-none"
                />
              </div>
            </div>
            <div class="flex flex-col">
              <div
                v-for="(value, index) in basicFeatures"
                :key="index"
                class="h-[42px] flex justify-center items-center border-b border-surface-100 dark:border-surface-800"
              >
                <i
                  ...
                  :class="[
                    'pi',
                    value
                      ? 'pi-check text-blue-500 dark:text-blue-400'
                      : 'pi-times text-surface-500 dark:text-surface-300',
                  ]"
                />
                <div
                  v-else
          ...
          <div class="flex flex-1 flex-col">
            ...
            <div class="flex flex-col">
              <div
                v-for="(value, index) in premiumFeatures"
                :key="index"
                class="h-[42px] flex justify-center items-center border-b border-surface-100 dark:border-surface-800"
              >
                <i
          ...
          <div class="flex flex-1 flex-col">
            <div
              class="flex flex-col gap-4 p-px pl-0 h-28 md:h-[146px] relative z-10 rounded-tr-xl before:content-[''] before:absolute before:inset-0 before:pointer-events-none before:bg-linear-to-b before:from-blue-500 dark:before:from-blue-400 before:to-transparent before:border-0 before:p-px before:rounded-tr-xl before:z-0"
            >
              <div
                class="relative z-10 h-full w-full bg-surface-0 dark:bg-surface-950 p-4 flex flex-col items-center gap-4 rounded-tr-xl"
              >
                <div class="flex flex-col gap-2">
                  <div
                    class="text-lg md:text-xl leading-normal font-medium text-surface-900 dark:text-surface-0"
                ...
                <Button
                  ...
                  outlined
                  label="Contact Us"
                  class="md:flex! hidden! !text-blue-700 !border-blue-700"
                />
              </div>
            </div>
            <div class="flex flex-col">
              <div
                v-for="(value, index) in enterpriseFeatures"
                :key="index"
                class="h-[42px] flex justify-center items-center border-b border-surface-100 dark:border-surface-800"
              >
                <i
